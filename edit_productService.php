...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, '192.168.0.51:3000/api/v1/Productos/consultaProductoServicio/'. $Id);
...
$Nombre = $decodificada->msg->Nombre;
...
$Imagen = $decodificada->msg->Imagen;
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="infoEmpresa.php">
                        ...
                        <form action="editPS.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                <div class="card-header" align="center">
                                    Elija si desea crear un producto o un servicio
                                </div>
